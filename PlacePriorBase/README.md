...
to be trained on directly. Crop them into 1024×1024 patches with 200-px overlap using the
provided split tool (adapted from [point2rbox-v2](https://github.com/VisionXLab/point2rbox-v2);
